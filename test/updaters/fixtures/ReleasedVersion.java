...
public final class Version {
  ...
  public static String INLINE_VERSION = "1.2.3"; // {x-release-please-released-version}
  public static String INLINE_MAJOR = "1"; // {x-release-please-released-major}
  public static String INLINE_MINOR = "2"; // {x-release-please-released-minor}
  public static String INLINE_PATCH = "3"; // {x-release-please-released-patch}
