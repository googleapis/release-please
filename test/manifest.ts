...
describe('Manifest', () => {
  ...
  describe('buildReleases', () => {
    ...
    it('should build prerelease releases manifest wide from beta', async () => {
      mockPullRequests(
        github,
        [],
        [
    ...
    it('should not build prerelease releases manifest wide from non-prerelease', async () => {
      mockPullRequests(
        github,
        [],
        [
