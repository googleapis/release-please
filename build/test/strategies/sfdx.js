...
const sfdx_1 = require("../../src/strategies/sfdx");
...
(0, mocha_1.describe)('Sfdx', () => {
    ...
    (0, mocha_1.describe)('buildReleasePullRequest', () => {
        (0, mocha_1.it)('returns release PR changes with defaultInitialVersion', async () => {
            ...
            const strategy = new sfdx_1.Sfdx({
                targetBranch: 'main',
                github,
        ...
        (0, mocha_1.it)('builds a release pull request', async () => {
            ...
            const latestRelease = {
                tag: new tag_name_1.TagName(version_1.Version.parse('0.123.4'), 'some-sfdx-package'),
                sha: 'abc123',
                notes: 'some notes',
            };
        ...
        (0, mocha_1.it)('detects a default component', async () => {
            ...
            const latestRelease = {
                tag: new tag_name_1.TagName(version_1.Version.parse('0.123.4'), 'sfdx-test-repo'),
                sha: 'abc123',
                notes: 'some notes',
            };
