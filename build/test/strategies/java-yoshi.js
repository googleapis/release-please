...
(0, mocha_1.describe)('JavaYoshi', () => {
    ...
    (0, mocha_1.describe)('buildReleasePullRequest', () => {
        (0, mocha_1.it)('returns release PR changes with defaultInitialVersion', async () => {
            ...
            const strategy = new java_yoshi_1.JavaYoshi({
                targetBranch: 'main',
                github,
        ...
        (0, mocha_1.it)('throws on missing required versions.txt', async () => {
            const strategy = new java_yoshi_1.JavaYoshi({
                targetBranch: 'main',
                github,
                component: 'google-cloud-automl',
            ...
            getFileContentsStub
                .withArgs('versions.txt', 'main')
                .throws(new errors_1.FileNotFoundError('versions.txt'));
            const latestRelease = {
                tag: new tag_name_1.TagName(version_1.Version.parse('0.123.4'), 'google-cloud-automl'),
                sha: 'abc123',
                notes: 'some notes',
            ...
            (0, chai_1.expect)(failed).to.be.true;
        });
    });
