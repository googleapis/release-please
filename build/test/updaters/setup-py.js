...
(0, mocha_1.describe)('setup.py', () => {
    (0, mocha_1.describe)('updateContent', () => {
        (0, mocha_1.it)('updates version in setup.py', async () => {
            const oldContent = (0, fs_1.readFileSync)((0, path_1.resolve)(fixturesPath, './setup.py'), 'utf8').replace(/\r\n/g, '\n');
