...
(0, mocha_1.describe)('Opam', () => {
    (0, mocha_1.describe)('updateContent', () => {
        (0, mocha_1.it)('updates version in opam file', async () => {
            const oldContent = (0, fs_1.readFileSync)((0, path_1.resolve)(fixturesPath, './sample.opam'), 'utf8').replace(/\r\n/g, '\n');
