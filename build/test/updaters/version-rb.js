...
(0, mocha_1.describe)('version.rb', () => {
    (0, mocha_1.describe)('updateContent', () => {
        ...
        testTable.forEach(([newVersion, existingContent, expected, shouldUpdate, description]) => {
        ...
        (0, mocha_1.it)('updates version in version.rb', async () => {
            const oldContent = (0, fs_1.readFileSync)((0, path_1.resolve)(fixturesPath, './version.rb'), 'utf8').replace(/\r\n/g, '\n');
            const version = new version_rb_1.VersionRB({
        ...
        (0, mocha_1.it)('updates content with single quotes in version.rb', async () => {
            const oldContent = (0, fs_1.readFileSync)((0, path_1.resolve)(fixturesPath, './version.rb'), 'utf8')
                .replace(/\r\n/g, '\n')
                .replace(/"/g, "'");
            const version = new version_rb_1.VersionRB({
                version: version_1.Version.parse('0.6.0'),
        ...
        (0, mocha_1.it)('updates long patch versions in version.rb', async () => {
            const oldContent = (0, fs_1.readFileSync)((0, path_1.resolve)(fixturesPath, './version-with-long-patch.rb'), 'utf8').replace(/\r\n/g, '\n');
            const version = new version_rb_1.VersionRB({
                version: version_1.Version.parse('0.6.11'),
            });
            const newContent = version.updateContent(oldContent);
            snapshot(newContent);
        });
        (0, mocha_1.it)('updates prerelease versions in version.rb', async () => {
            const oldContent = (0, fs_1.readFileSync)((0, path_1.resolve)(fixturesPath, './version-with-prerelease.rb'), 'utf8').replace(/\r\n/g, '\n');
            const version = new version_rb_1.VersionRB({
                version: version_1.Version.parse('10.0.0-alpha1'),
            });
            const newContent = version.updateContent(oldContent);
            snapshot(newContent);
        });
