...
const always_bump_minor_1 = require("../../src/versioning-strategies/always-bump-minor");
const version_1 = require("../../src/version");
(0, mocha_1.describe)('AlwaysBumpMinorStrategy', () => {
    (0, mocha_1.describe)('with breaking change', () => {
        ...
        (0, mocha_1.it)('bumps minor for major', async () => {
            const strategy = new always_bump_minor_1.AlwaysBumpMinor();
    ...
    (0, mocha_1.describe)('with a feature', () => {
        ...
        (0, mocha_1.it)('bumps minor', async () => {
            const strategy = new always_bump_minor_1.AlwaysBumpMinor();
            const oldVersion = version_1.Version.parse('1.2.3');
            const newVersion = await strategy.bump(oldVersion, commits);
            (0, chai_1.expect)(newVersion.toString()).to.equal('1.3.0');
    ...
    (0, mocha_1.describe)('with a fix', () => {
        ...
        (0, mocha_1.it)('bumps minor for patch', async () => {
            const strategy = new always_bump_minor_1.AlwaysBumpMinor();
            const oldVersion = version_1.Version.parse('1.2.3');
            const newVersion = await strategy.bump(oldVersion, commits);
            (0, chai_1.expect)(newVersion.toString()).to.equal('1.3.0');
