...
| `--prerelease-initial-number`      | `number`                                                                | Configuration option for the prerelease versioning strategy. Sets the starting number appended to the first generated prerelease, e.g. `1` results in a first prerelease of `1.0.0-alpha.1` instead of `1.0.0-alpha`. Must be a non-negative integer. |
...
| `--include-commit-authors`         | `boolean`                                                               | Include commit authors in changelog entries (e.g., `(@username)`). Defaults to `false`                                                                                                                           |
