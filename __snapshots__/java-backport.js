exports['JavaBackport creates a release PR against a feature branch: changes'] = `

filename: CHANGELOG.md
# Changelog

### [0.20.4](https://www.github.com/googleapis/java-trace/compare/0.20.3...v0.20.4) (1983-10-10)
...
exports['JavaBackport creates a release PR against a feature branch: options'] = `
...
exports['JavaBackport creates a release PR: changes'] = `
...
exports['JavaBackport creates a release PR: options'] = `
...
exports['JavaBackport creates a snapshot PR if an explicit release is requested, but a snapshot is needed: changes'] = `
...
exports['JavaBackport creates a snapshot PR if an explicit release is requested, but a snapshot is needed: options'] = `
...
exports['JavaBackport creates a snapshot PR, when latest release sha is head: changes'] = `
...
exports['JavaBackport creates a snapshot PR, when latest release sha is head: options'] = `
...
exports['JavaBackport creates a snapshot PR: changes'] = `
...
exports['JavaBackport creates a snapshot PR: options'] = `
