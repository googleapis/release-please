exports['NodeWorkspace2 plugin run appends dependency notes to an updated module 1'] = `
...
exports['NodeWorkspace2 plugin run combines node packages 1'] = `
:robot: I have created a release *beep* *boop*
---
...
exports['NodeWorkspace2 plugin run handles a single node package 1'] = `
:robot: I have created a release *beep* *boop*
---
...
exports['NodeWorkspace2 plugin run walks dependency tree and updates previously untouched packages 1'] = `
:robot: I have created a release *beep* *boop*
---
